...
img_hive = pygame.image.load('hive.png')
...
buy_upgrade_buzz = button((255,255,0), 250, 90, 40, 40, '+')
...
while running:
    ...
    if upgrade_visible == True:
        buy_upgrade_buzz.draw(screen,(0,0,0))
...
#   Bee-Shop
    ...
    if upgrade_visible == True:
        ...
        GAME_FONT.render_to(screen, (44, 90), 'Honey Buzzzzz', (0, 0, 0))
        GAME_FONT.render_to(screen, (44, 110), 'Price:'+str(price_upgrade_buzz), (0, 0, 0))
